...
shellcmd xsh_udpclient(int nargs, char *args[])
{
	...
	char	msg[] = "Xinu says hello to vm"; /* message to send	*/
	...
	uint16	echoport= 1111;		/* port number for UDP echo	*/
	...
	if (nargs == 2 && strncmp(args[1], "--help", 7) == 0) {
		...
		printf("Description:\n");
		printf("\tSend a message off a remote vm server\n");
		printf("Options:\n");
	...
	*/
	...
	printf("Sending hello to VM was successful\n");
	return 0;
}
